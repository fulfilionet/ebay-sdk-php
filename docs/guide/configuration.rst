...
This guide describes the service configuration options. These options can be provided in a service constructor or to the ``FulfilioNet\eBaySDK\Sdk`` class.
...
.. code-block:: php
    ...
    use FulfilioNet\eBaySDK\Shopping\Services\ShoppingService;
...
.. code-block:: php
    ...
    use FulfilioNet\eBaySDK\Trading\Types;
    use FulfilioNet\eBaySDK\Trading\Services;
...
.. code-block:: php
    ...
    use FulfilioNet\eBaySDK\Browse\Services\BrowseService;
...
:Type: ``array|FulfilioNet\eBaySDK\Credentials\CredentialsInterface|callable``
...
You can also pass an instance of the ``FulfilioNet\eBaySDK\Credentials\CredentialsInterface`` interface.
