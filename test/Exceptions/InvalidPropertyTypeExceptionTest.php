<?php
namespace FulfilioNet\eBaySDK\Exceptions\Test;

use FulfilioNet\eBaySDK\Exceptions\InvalidPropertyTypeException;
...
class InvalidPropertyTypeExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Exceptions\InvalidPropertyTypeException', $this->obj);
    }
