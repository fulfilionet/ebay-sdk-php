...
use FulfilioNet\eBaySDK\MerchantData\Types\OrderAckResponseType;
...
class OrderAckResponseTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\MerchantData\Types\OrderAckResponseType', $this->obj);
    }
