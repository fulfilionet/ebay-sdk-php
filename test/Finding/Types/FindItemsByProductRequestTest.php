...
use FulfilioNet\eBaySDK\Finding\Types\FindItemsByProductRequest;
...
class FindItemsByProductRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Finding\Types\FindItemsByProductRequest', $this->obj);
    }
