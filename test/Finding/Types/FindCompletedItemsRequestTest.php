...
use FulfilioNet\eBaySDK\Finding\Types\FindCompletedItemsRequest;
...
class FindCompletedItemsRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Finding\Types\FindCompletedItemsRequest', $this->obj);
    }
