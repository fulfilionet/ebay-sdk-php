...
use FulfilioNet\eBaySDK\Inventory\Enums\WeightUnitOfMeasureEnum;
...
class WeightUnitOfMeasureEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Inventory\Enums\WeightUnitOfMeasureEnum', $this->obj);
    }
}
