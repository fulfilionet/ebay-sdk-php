...
use FulfilioNet\eBaySDK\Inventory\Enums\ShippingServiceTypeEnum;
...
class ShippingServiceTypeEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Inventory\Enums\ShippingServiceTypeEnum', $this->obj);
    }
}
