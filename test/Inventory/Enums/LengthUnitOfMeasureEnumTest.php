...
use FulfilioNet\eBaySDK\Inventory\Enums\LengthUnitOfMeasureEnum;
...
class LengthUnitOfMeasureEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Inventory\Enums\LengthUnitOfMeasureEnum', $this->obj);
    }
}
