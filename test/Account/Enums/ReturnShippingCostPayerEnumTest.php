...
use FulfilioNet\eBaySDK\Account\Enums\ReturnShippingCostPayerEnum;
...
class ReturnShippingCostPayerEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Account\Enums\ReturnShippingCostPayerEnum', $this->obj);
    }
}
