...
use FulfilioNet\eBaySDK\Account\Types\RecipientAccountReference;
...
class RecipientAccountReferenceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Account\Types\RecipientAccountReference', $this->obj);
    }
