...
use FulfilioNet\eBaySDK\Trading\Enums\ConditionEnabledCodeType;
...
class ConditionEnabledCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\ConditionEnabledCodeType', $this->obj);
    }
}
