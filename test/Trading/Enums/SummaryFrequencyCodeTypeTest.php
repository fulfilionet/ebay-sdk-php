...
use FulfilioNet\eBaySDK\Trading\Enums\SummaryFrequencyCodeType;
...
class SummaryFrequencyCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\SummaryFrequencyCodeType', $this->obj);
    }
}
