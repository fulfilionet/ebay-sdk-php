...
use FulfilioNet\eBaySDK\Trading\Enums\WirelessCarrierIDCodeType;
...
class WirelessCarrierIDCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\WirelessCarrierIDCodeType', $this->obj);
    }
}
