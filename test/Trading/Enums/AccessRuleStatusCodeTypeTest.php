...
use FulfilioNet\eBaySDK\Trading\Enums\AccessRuleStatusCodeType;
...
class AccessRuleStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\AccessRuleStatusCodeType', $this->obj);
    }
}
