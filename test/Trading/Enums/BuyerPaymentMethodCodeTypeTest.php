...
use FulfilioNet\eBaySDK\Trading\Enums\BuyerPaymentMethodCodeType;
...
class BuyerPaymentMethodCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\BuyerPaymentMethodCodeType', $this->obj);
    }
}
