...
use FulfilioNet\eBaySDK\Trading\Enums\DisplayPayNowButtonCodeType;
...
class DisplayPayNowButtonCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\DisplayPayNowButtonCodeType', $this->obj);
    }
}
