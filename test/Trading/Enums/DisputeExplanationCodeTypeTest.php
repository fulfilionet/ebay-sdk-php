...
use FulfilioNet\eBaySDK\Trading\Enums\DisputeExplanationCodeType;
...
class DisputeExplanationCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\DisputeExplanationCodeType', $this->obj);
    }
}
