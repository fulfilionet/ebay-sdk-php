...
use FulfilioNet\eBaySDK\Trading\Enums\BidGroupItemStatusCodeType;
...
class BidGroupItemStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\BidGroupItemStatusCodeType', $this->obj);
    }
}
