...
use FulfilioNet\eBaySDK\Trading\Enums\TransactionPlatformCodeType;
...
class TransactionPlatformCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\TransactionPlatformCodeType', $this->obj);
    }
}
