...
use FulfilioNet\eBaySDK\Trading\Enums\ShippingRateTypeCodeType;
...
class ShippingRateTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\ShippingRateTypeCodeType', $this->obj);
    }
}
