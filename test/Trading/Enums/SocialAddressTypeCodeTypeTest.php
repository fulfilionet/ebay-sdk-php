...
use FulfilioNet\eBaySDK\Trading\Enums\SocialAddressTypeCodeType;
...
class SocialAddressTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\SocialAddressTypeCodeType', $this->obj);
    }
}
