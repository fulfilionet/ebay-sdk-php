...
use FulfilioNet\eBaySDK\Trading\Enums\FeedbackResponseCodeType;
...
class FeedbackResponseCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\FeedbackResponseCodeType', $this->obj);
    }
}
