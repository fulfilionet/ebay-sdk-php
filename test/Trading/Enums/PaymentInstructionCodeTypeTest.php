...
use FulfilioNet\eBaySDK\Trading\Enums\PaymentInstructionCodeType;
...
class PaymentInstructionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PaymentInstructionCodeType', $this->obj);
    }
}
