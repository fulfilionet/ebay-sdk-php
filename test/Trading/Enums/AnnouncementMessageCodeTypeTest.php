...
use FulfilioNet\eBaySDK\Trading\Enums\AnnouncementMessageCodeType;
...
class AnnouncementMessageCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\AnnouncementMessageCodeType', $this->obj);
    }
}
