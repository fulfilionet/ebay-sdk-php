...
use FulfilioNet\eBaySDK\Trading\Enums\PurchasePurposeTypeCodeType;
...
class PurchasePurposeTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PurchasePurposeTypeCodeType', $this->obj);
    }
}
