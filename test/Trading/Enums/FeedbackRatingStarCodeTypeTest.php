...
use FulfilioNet\eBaySDK\Trading\Enums\FeedbackRatingStarCodeType;
...
class FeedbackRatingStarCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\FeedbackRatingStarCodeType', $this->obj);
    }
}
