...
use FulfilioNet\eBaySDK\Trading\Enums\RefundSourceTypeCodeType;
...
class RefundSourceTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\RefundSourceTypeCodeType', $this->obj);
    }
}
