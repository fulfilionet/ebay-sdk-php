...
use FulfilioNet\eBaySDK\Trading\Enums\ErrorClassificationCodeType;
...
class ErrorClassificationCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\ErrorClassificationCodeType', $this->obj);
    }
}
