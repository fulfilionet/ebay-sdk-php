...
use FulfilioNet\eBaySDK\Trading\Enums\PictureWatermarkCodeType;
...
class PictureWatermarkCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PictureWatermarkCodeType', $this->obj);
    }
}
