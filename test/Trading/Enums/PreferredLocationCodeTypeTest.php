...
use FulfilioNet\eBaySDK\Trading\Enums\PreferredLocationCodeType;
...
class PreferredLocationCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PreferredLocationCodeType', $this->obj);
    }
}
