...
use FulfilioNet\eBaySDK\Trading\Enums\PerformanceStatusCodeType;
...
class PerformanceStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PerformanceStatusCodeType', $this->obj);
    }
}
