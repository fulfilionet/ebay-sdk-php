...
use FulfilioNet\eBaySDK\Trading\Enums\NotificationRoleCodeType;
...
class NotificationRoleCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\NotificationRoleCodeType', $this->obj);
    }
}
