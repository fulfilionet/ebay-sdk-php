...
use FulfilioNet\eBaySDK\Trading\Enums\PaymentHoldStatusCodeType;
...
class PaymentHoldStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PaymentHoldStatusCodeType', $this->obj);
    }
}
