...
use FulfilioNet\eBaySDK\Trading\Enums\CharitySellerStatusCodeType;
...
class CharitySellerStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\CharitySellerStatusCodeType', $this->obj);
    }
}
