...
use FulfilioNet\eBaySDK\Trading\Enums\SetUserNotesActionCodeType;
...
class SetUserNotesActionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\SetUserNotesActionCodeType', $this->obj);
    }
}
