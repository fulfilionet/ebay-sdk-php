...
use FulfilioNet\eBaySDK\Trading\Enums\RefundingSourceTypeCodeType;
...
class RefundingSourceTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\RefundingSourceTypeCodeType', $this->obj);
    }
}
