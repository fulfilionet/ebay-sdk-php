...
use FulfilioNet\eBaySDK\Trading\Enums\StoreItemListLayoutCodeType;
...
class StoreItemListLayoutCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\StoreItemListLayoutCodeType', $this->obj);
    }
}
