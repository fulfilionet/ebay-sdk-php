...
use FulfilioNet\eBaySDK\Trading\Enums\RecipientRelationCodeType;
...
class RecipientRelationCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\RecipientRelationCodeType', $this->obj);
    }
}
