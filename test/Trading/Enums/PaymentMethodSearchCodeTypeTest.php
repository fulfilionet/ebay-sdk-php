...
use FulfilioNet\eBaySDK\Trading\Enums\PaymentMethodSearchCodeType;
...
class PaymentMethodSearchCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PaymentMethodSearchCodeType', $this->obj);
    }
}
