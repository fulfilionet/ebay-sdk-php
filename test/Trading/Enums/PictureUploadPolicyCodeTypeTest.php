...
use FulfilioNet\eBaySDK\Trading\Enums\PictureUploadPolicyCodeType;
...
class PictureUploadPolicyCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PictureUploadPolicyCodeType', $this->obj);
    }
}
