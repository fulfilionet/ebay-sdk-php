...
use FulfilioNet\eBaySDK\Trading\Enums\PayPalAccountStatusCodeType;
...
class PayPalAccountStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PayPalAccountStatusCodeType', $this->obj);
    }
}
