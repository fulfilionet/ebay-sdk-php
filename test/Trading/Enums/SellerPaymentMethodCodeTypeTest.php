...
use FulfilioNet\eBaySDK\Trading\Enums\SellerPaymentMethodCodeType;
...
class SellerPaymentMethodCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\SellerPaymentMethodCodeType', $this->obj);
    }
}
