...
use FulfilioNet\eBaySDK\Trading\Enums\RCSPaymentStatusCodeType;
...
class RCSPaymentStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\RCSPaymentStatusCodeType', $this->obj);
    }
}
