...
use FulfilioNet\eBaySDK\Trading\Enums\HomePageFeaturedCodeType;
...
class HomePageFeaturedCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\HomePageFeaturedCodeType', $this->obj);
    }
}
