...
use FulfilioNet\eBaySDK\Trading\Enums\OrderStatusFilterCodeType;
...
class OrderStatusFilterCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\OrderStatusFilterCodeType', $this->obj);
    }
}
