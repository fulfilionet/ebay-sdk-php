...
use FulfilioNet\eBaySDK\Trading\Enums\PayPalAccountLevelCodeType;
...
class PayPalAccountLevelCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\PayPalAccountLevelCodeType', $this->obj);
    }
}
