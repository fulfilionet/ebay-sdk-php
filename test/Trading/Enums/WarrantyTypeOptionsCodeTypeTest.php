...
use FulfilioNet\eBaySDK\Trading\Enums\WarrantyTypeOptionsCodeType;
...
class WarrantyTypeOptionsCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\WarrantyTypeOptionsCodeType', $this->obj);
    }
}
