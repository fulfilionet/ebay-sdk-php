...
use FulfilioNet\eBaySDK\Trading\Enums\InsuranceSelectedCodeType;
...
class InsuranceSelectedCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Trading\Enums\InsuranceSelectedCodeType', $this->obj);
    }
}
