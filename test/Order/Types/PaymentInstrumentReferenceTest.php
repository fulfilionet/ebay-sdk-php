...
use FulfilioNet\eBaySDK\Order\Types\PaymentInstrumentReference;
...
class PaymentInstrumentReferenceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Order\Types\PaymentInstrumentReference', $this->obj);
    }
