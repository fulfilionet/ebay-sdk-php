...
use FulfilioNet\eBaySDK\Browse\Enums\AvailabilityThresholdEnum;
...
class AvailabilityThresholdEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Browse\Enums\AvailabilityThresholdEnum', $this->obj);
    }
}
