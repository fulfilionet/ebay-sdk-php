...
use FulfilioNet\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse;
...
class RefreshUserTokenRestResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse', $this->obj);
    }
