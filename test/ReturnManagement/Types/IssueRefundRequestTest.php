...
use FulfilioNet\eBaySDK\ReturnManagement\Types\IssueRefundRequest;
...
class IssueRefundRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\ReturnManagement\Types\IssueRefundRequest', $this->obj);
    }
