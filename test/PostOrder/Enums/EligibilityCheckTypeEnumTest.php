...
use FulfilioNet\eBaySDK\PostOrder\Enums\EligibilityCheckTypeEnum;
...
class EligibilityCheckTypeEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\PostOrder\Enums\EligibilityCheckTypeEnum', $this->obj);
    }
}
