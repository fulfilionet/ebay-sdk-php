...
use FulfilioNet\eBaySDK\PostOrder\Enums\RuleListFieldGroupEnum;
...
class RuleListFieldGroupEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\PostOrder\Enums\RuleListFieldGroupEnum', $this->obj);
    }
}
