...
use FulfilioNet\eBaySDK\PostOrder\Enums\MoneyMovementStatusEnum;
...
class MoneyMovementStatusEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\PostOrder\Enums\MoneyMovementStatusEnum', $this->obj);
    }
}
