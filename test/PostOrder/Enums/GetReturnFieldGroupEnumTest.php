...
use FulfilioNet\eBaySDK\PostOrder\Enums\GetReturnFieldGroupEnum;
...
class GetReturnFieldGroupEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\PostOrder\Enums\GetReturnFieldGroupEnum', $this->obj);
    }
}
