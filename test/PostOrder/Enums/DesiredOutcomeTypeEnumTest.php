...
use FulfilioNet\eBaySDK\PostOrder\Enums\DesiredOutcomeTypeEnum;
...
class DesiredOutcomeTypeEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\PostOrder\Enums\DesiredOutcomeTypeEnum', $this->obj);
    }
}
