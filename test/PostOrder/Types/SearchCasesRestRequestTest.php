...
use FulfilioNet\eBaySDK\PostOrder\Types\SearchCasesRestRequest;
...
class SearchCasesRestRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\PostOrder\Types\SearchCasesRestRequest', $this->obj);
    }
