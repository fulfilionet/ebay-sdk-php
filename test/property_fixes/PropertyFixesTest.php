...
use FulfilioNet\eBaySDK as Sdk;
/**
...
class PropertyFixesTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCancelSummary()
    {
        ...
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Types\RepeatableType', $obj->lineItems);
    }
    ...
    public function testDeliveryCost()
    {
        ...
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Fulfillment\Types\Amount', $obj->discountAmount);
    }
    ...
    public function testPriceDiscount()
    {
        ...
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Fulfillment\Types\Amount', $obj->priceDiscount);
    }

    public function testPriceDiscountSubtotalDoesNotExist()
    {
        $this->setExpectedException('\FulfilioNet\eBaySDK\Exceptions\UnknownPropertyException', 'Unknown property');
