...
use FulfilioNet\eBaySDK\FileTransfer\Types;
...
class AttachmentTest extends \PHPUnit_Framework_TestCase
{
    public function testAttachmentFieldIsSetCorrectlyInRequest()
    {
        ...
        $this->assertEquals(null, $r->fileAttachment);
        $s->uploadFile($r);
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\FileTransfer\Types\FileAttachment', $r->fileAttachment);
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\FileTransfer\Types\Data', $r->fileAttachment->Data);
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\FileTransfer\Types\XopInclude', $r->fileAttachment->Data->xopInclude);
