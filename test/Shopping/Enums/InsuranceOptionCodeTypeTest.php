...
use FulfilioNet\eBaySDK\Shopping\Enums\InsuranceOptionCodeType;
...
class InsuranceOptionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Shopping\Enums\InsuranceOptionCodeType', $this->obj);
    }
}
