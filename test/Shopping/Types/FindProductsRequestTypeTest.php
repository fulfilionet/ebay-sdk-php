...
use FulfilioNet\eBaySDK\Shopping\Types\FindProductsRequestType;
...
class FindProductsRequestTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\FulfilioNet\eBaySDK\Shopping\Types\FindProductsRequestType', $this->obj);
    }
