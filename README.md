...
[![Build Status](https://travis-ci.org/fulfilionet/ebay-sdk-php.svg?branch=master)](https://travis-ci.org/davidtsadler/ebay-sdk-php)
...
This is a personal project that has been developed by, [David T. Sadler](http://twitter.com/davidtsadler). I decided to create this project to make up for the lack of an official SDK for PHP. It is in no way endorsed, sponsored or maintained by eBay.
