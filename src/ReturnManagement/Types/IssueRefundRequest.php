 ...
 * @property \FulfilioNet\eBaySDK\ReturnManagement\Types\RefundDetailType $refundDetail
 * @property string $comments
 */
class IssueRefundRequest extends \FulfilioNet\eBaySDK\ReturnManagement\Types\BaseRequest
{
    /**
