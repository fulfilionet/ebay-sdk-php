 ...
 * @property \FulfilioNet\eBaySDK\Marketing\Types\ErrorDetailV3[] $warnings
 */
class BulkCreateAdsByInventoryReferenceRestResponse extends \FulfilioNet\eBaySDK\Marketing\Types\BulkCreateAdsByInventoryReferenceResponse
{
    use StatusCodeTrait;
