...
/**
 *
 * @property \FulfilioNet\eBaySDK\Product\Types\ProductSubmission[] $addProductRequest
 * @property string $clientBatchId
 */
class AddProductsRequest extends \FulfilioNet\eBaySDK\Product\Types\BaseServiceRequest
{
    /**
