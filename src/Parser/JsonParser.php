...
{
    /**
     * @param mixed A PHP object derived from FulfilioNet\eBaySDK\Types\BaseType
    ...
    private static function assignProperties(\FulfilioNet\eBaySDK\Types\BaseType $object, array $properties)
    {
