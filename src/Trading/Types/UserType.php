 ...
 * @property \FulfilioNet\eBaySDK\Trading\Types\AddressType $RegistrationAddress
 * @property \DateTime $RegistrationDate
 * @property \FulfilioNet\eBaySDK\Trading\Enums\SiteCodeType $Site
 * @property \FulfilioNet\eBaySDK\Trading\Enums\UserStatusCodeType $Status
 * @property string $UserID
 * @property boolean $UserIDChanged
 * @property \DateTime $UserIDLastChanged
 * @property \FulfilioNet\eBaySDK\Trading\Enums\VATStatusCodeType $VATStatus
 * @property \FulfilioNet\eBaySDK\Trading\Types\BuyerType $BuyerInfo
 * @property \FulfilioNet\eBaySDK\Trading\Types\SellerType $SellerInfo
 * @property \FulfilioNet\eBaySDK\Trading\Enums\BusinessRoleType $BusinessRole
 * @property \FulfilioNet\eBaySDK\Trading\Enums\PayPalAccountLevelCodeType $PayPalAccountLevel
 * @property \FulfilioNet\eBaySDK\Trading\Enums\PayPalAccountTypeCodeType $PayPalAccountType
 * @property \FulfilioNet\eBaySDK\Trading\Enums\PayPalAccountStatusCodeType $PayPalAccountStatus
 * @property \FulfilioNet\eBaySDK\Trading\Enums\EBaySubscriptionTypeCodeType[] $UserSubscription
 * @property boolean $eBayWikiReadOnly
 * @property integer $TUVLevel
 * @property string $VATID
 * @property boolean $MotorsDealer
 * @property \FulfilioNet\eBaySDK\Trading\Types\BiddingSummaryType $BiddingSummary
 ...
 * @property \FulfilioNet\eBaySDK\Trading\Types\MembershipDetailsType $Membership
...
class UserType extends \FulfilioNet\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'BuyerInfo' => [
            'type' => 'FulfilioNet\eBaySDK\Trading\Types\BuyerType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BuyerInfo'
        ],
        'SellerInfo' => [
            'type' => 'FulfilioNet\eBaySDK\Trading\Types\SellerType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BiddingSummary' => [
            'type' => 'FulfilioNet\eBaySDK\Trading\Types\BiddingSummaryType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'Membership' => [
            'type' => 'FulfilioNet\eBaySDK\Trading\Types\MembershipDetailsType',
            'repeatable' => false,
            'attribute' => false,
