 ...
 */
class TradingBaseService extends \FulfilioNet\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \FulfilioNet\eBaySDK\Trading\Services\TradingService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string']
    ...
    protected function callOperationAsync($name, \FulfilioNet\eBaySDK\Types\BaseType $request, $responseClass)
    {
        ...
        if ($this->getConfig('authorization') !== null) {
             ...
             */
            if (!isset($request->RequesterCredentials)) {
                $request->RequesterCredentials = new \FulfilioNet\eBaySDK\Trading\Types\CustomSecurityHeaderType();
            }
     ...
     */
    protected function buildRequestBody(\FulfilioNet\eBaySDK\Types\BaseType $request)
    {
