 ...
 * @property \FulfilioNet\eBaySDK\RelatedItemsManagement\Enums\ErrorSeverity $severity
 * @property \FulfilioNet\eBaySDK\RelatedItemsManagement\Enums\ErrorCategory $category
 * @property string $message
 * @property string $exceptionId
 * @property \FulfilioNet\eBaySDK\RelatedItemsManagement\Types\ErrorParameter[] $parameter
 */
class ErrorData extends \FulfilioNet\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'parameter' => [
            'type' => 'FulfilioNet\eBaySDK\RelatedItemsManagement\Types\ErrorParameter',
            'repeatable' => true,
            'attribute' => false,
