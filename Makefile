...
sync_file:
	...
	sed -i -e "s/@property string/@property \\\FulfilioNet\\\eBaySDK\\\FileTransfer\\\Types\\\Data/" src/FileTransfer/Types/FileAttachment.php
	sed -i -e "s/'string'/'FulfilioNet\\\eBaySDK\\\FileTransfer\\\Types\\\Data'/" src/FileTransfer/Types/FileAttachment.php
